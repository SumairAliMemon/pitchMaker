...
import { ArrowLeft, Calendar, Clock, Copy, Eye, FileText, Search, Trash2 } from 'lucide-react'
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Pitch History</h1>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-gray-50 rounded-2xl border-0 focus:ring-2 focus:ring-blue-500 text-gray-900 placeholder-gray-500"
            />
          </div>
        </div>
        ...
        {filteredHistory.length > 0 ? (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {filteredHistory.map((pitch) => (
              <div key={pitch.id} className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 hover:shadow-2xl transition-shadow duration-200">
